    ...
    <View className="flex-1">
      ...
      <View className="absolute bottom-0 w-full bg-transparent">
        <Ripple
          ...
          onPress={() => {
            router.navigate("/Events/EditEvent");
          }}
        >
        ...
        <View className=" bg-primary rounded-t-3xl w-full">
          <View className="flex-row items-center mx-6 my-8 justify-between">
            ...
            <Ripple
              className="bg-white overflow-hidden rounded-lg p-2 flex-row items-center gap-2"
              onPress={() => {
                // router.dismissTo("/(root)/CreateEvent/Page4");
              }}
            >
      ...
      <EventCreatedModal visible={eventCreated} />
    </View>
  );
};
